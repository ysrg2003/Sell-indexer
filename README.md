...
ستقوم بإنشاء ملف index.html ليس على GitHub (حيث انه سبحذف GitHub tokenمباشرة لان المستودع عام ولا تفكر بجعله خاصا),. إليك أهم الأسطر التي ستقوم بتغييرها في كل مرة:
